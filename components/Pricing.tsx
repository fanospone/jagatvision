        ...
        <section className="w-full bg-[#1f57c3] py-24 relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="flex justify-between items-start mb-20">
                    ...
                    {/* Circle */}
                    <div
                        className="hidden md:flex items-center justify-center w-48 h-48 rounded-full border border-blue-200 text-blue-100">
                        Harga Terbaik
                    </div>
                ...
                <div className="flex justify-center gap-16 flex-wrap">
                    ...
                    {/* CARD 1 */}
                    <div
                        className="group relative bg-white rounded-xl w-[320px] shadow-lg overflow-hidden transition duration-300 hover:scale-105">
                        ...
                        {/* FULL CARD OVERLAY */}
                        <div
                            className="absolute inset-0 bg-blue-900/60 opacity-0 group-hover:opacity-100 transition duration-300 flex items-center justify-center rounded-xl">

                            <button
                                className="bg-white text-blue-900 px-6 py-3 rounded-lg font-semibold shadow-md hover:bg-gray-100 transition">
                                Order
                            </button>
